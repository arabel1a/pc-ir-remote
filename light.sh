...
path_to_sender='python3 /home/arabella/work/alarm/arduino_ir/send.py' # 'python3 /home/arabella/work/alarm/audio_ir/send.py'
...
alarm() {
    ...
    echo "bash -c '$SOURCE_CMD light_night_mode $REDIRRECT_CMD'" | at $TIME
    for (( i = 0; i < 6; i+=1 )); do
